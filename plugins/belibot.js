...
`.trim()
    const button = {
        ...
        {title: '4 Bulan', description: "Rp14.000\nSewa bot selama 1 minggu.", rowId:".payment"},
        {title: '1 Bulan', description: "Rp19.000\nSewa bot selama 3 minggu.", rowId:".payment"},
        {title: '8 bulan', description: "Rp30.000\nSewa bot selama 8 minggu.", rowId:".payment"},
